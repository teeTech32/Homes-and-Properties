...
function Editlisting() {
  ...
  // Edit to get Listing to pre-fill
  useEffect(()=>{
      setLoading(true)
  ...
  if(geolocationEnable){
    const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${address}&sensor=false&key=${process.env.REACT_APP_API_KEY}`)
            ...
            <label className='formLabelSmall'>Bathrooms</label>
                ...
                <>
                  <div className="formLatLng flex">
                    <div>
                      <label className='formLabelSmall'>Latitute</label>
                      <input type="number"
                    ...
                    <div>
                      <label className='formLabelSmall'>Longitude</label>
                      <input type="number"
                          className="inputSmall"
                          id='longitude'
                          value={longitude} 
