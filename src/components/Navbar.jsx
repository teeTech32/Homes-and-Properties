 ...
 return (
          <div data-aos='zoom-in'
            ...
            data-aos-easing='ease-out-sine' class='navbar bg-slate-800 p-1  relative'>
              <div class='group cursor-pointer  absolute top-6 md:top-5 left-10 md:left-16' onClick={() => navigate('/')}>
              ...
              <div class='group cursor-pointer  absolute top-6 md:top-5 right-10 md:right-16' onClick={() => navigate('/profile')}>
